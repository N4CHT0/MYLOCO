            ...
            <View style={events.content}>
              <TouchableOpacity onPress={handleNavigateToEventsDetail}>
                <Image
                  style={events.image}
                  source={{
                    uri: 'https://jbsatoday.com/wp-content/uploads/2021/10/MurphWorkoutJanus.jpg',
                  }}></Image>
              </TouchableOpacity>
              <Image
                style={events.image}
                source={{
                  uri: 'https://fitnessvolt.com/wp-content/uploads/2023/05/woman-posing-1024x710.jpg',
                }}></Image>
            </View>
          </View>
          <View style={events.container}>
